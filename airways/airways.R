...
BiocManager::install(c("airway","biomaRt","edgeR","ggplot2", "limma","ggrepel", "SummarizedExperiment"))
...
write.csv(filteredCountsMatUQ, file = "~/reproducible-r-workshop-lucy/airways/filteredCountsMatUQ.csv")
